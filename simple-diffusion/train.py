...
if __name__ == "__main__":
    ...
    parser.add_argument("--resolution", type=int, default=16) #64
    parser.add_argument("--train_batch_size", type=int, default=4) #16
    parser.add_argument("--eval_batch_size", type=int, default=4) #32
    ...
    parser.add_argument("--lr_warmup_steps", type=int, default=200) #500
    ...
    # parser.add_argument("--ckpt_dir", type=str, default="ddpm-checkpoints", help="Directory to save checkpoints")
    # parser.add_argument("--checkpoint_interval", type=int, default=10, help="Interval for saving checkpoints during training")
